...
SNR=0.1;                % The amount of noise after passing from an AWGN channel(Not exactly sure how to measure it with dB scale
...
h = modem.pskmod('M',8,'PhaseOffset',0,'SymbolOrder','binary');    % Create a modulator object
